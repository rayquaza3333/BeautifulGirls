...
// Load this file's selection again by visiting: http://mootools.net/more/4692e7181c3b58b175378a75e3bed3c8 
// Or build this file again with packager using: packager build More/More More/Events.Pseudos More/Class.Refactor More/Chain.Wait More/Date More/Date.Extras More/Number.Format More/String.QueryString More/URI More/URI.Relative More/Element.Forms More/Element.Event.Pseudos More/Element.Event.Pseudos.Keys More/Element.Delegation More/Element.Measure More/Element.Pin More/Element.Position More/Element.Shortcuts More/Form.Request More/Fx.Elements More/Fx.Accordion More/Fx.Move More/Fx.Reveal More/Fx.Scroll More/Fx.Slide More/Fx.SmoothScroll More/Fx.Sort More/Drag More/Drag.Move More/Request.JSONP More/Tips
/*
---
copyrights:
...
this.previous=c;var g=e.apply(this,arguments);this.previous=f;return g;}:e);});return b;};(function(){var a={wait:function(b){return this.chain(function(){this.callChain.delay(b==null?500:b,this);
...
var e=g.start+b.before.length;if(a!==false){this.selectRange(e,e+d.length);}else{this.setCaretPosition(e+f.length);}}return this;}});(function(){var d={},c=["once","throttle","pause"],b=c.length;
